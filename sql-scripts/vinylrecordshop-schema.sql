...
CREATE TABLE song (
    ...
    CONSTRAINT fk_song_band FOREIGN KEY (bandId)
...
CREATE TABLE songAlbum (
    ...
    CONSTRAINT fk_songAlbum_song FOREIGN KEY (songId)
		REFERENCES song (songId),
	CONSTRAINT fk_songAlbum_album FOREIGN KEY (albumId)
...
CREATE TABLE bandArtist(
    ...
    CONSTRAINT fk_bandArtist_band FOREIGN KEY (bandId)
		REFERENCES band (bandId),
	CONSTRAINT fk_bandArtist_artist FOREIGN KEY (artistId)
