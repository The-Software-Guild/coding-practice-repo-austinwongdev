...
CREATE TABLE `reservationroom` (
  ...
  KEY `fk_reservationroom_room` (`roomNumber`),
  CONSTRAINT `fk_reservationroom_reservation` FOREIGN KEY (`reservationID`) REFERENCES `reservation` (`reservationID`),
  CONSTRAINT `fk_reservationroom_room` FOREIGN KEY (`roomNumber`) REFERENCES `room` (`roomNumber`)
...
-- Dump completed on 2021-08-13 14:55:28
